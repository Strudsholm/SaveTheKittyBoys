...
namespace Webservice1.Controllers
{
    public class StatueTypesController : ApiController
    {
        ...
        public IHttpActionResult PostStatueType(StatueType statueType)
        {
            ...
            {
                if (StatueTypeExists(statueType.Type_ID))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtRoute("DefaultApi", new { id = statueType.Type_ID }, statueType);
        }
        ...
        {
            return db.StatueType.Count(e => e.Type_ID == id) > 0;
        }
    }
}